...
import { OrderUpdateResponse } from '@/types'
...
const UpdateOrderStatus = () => {
  ...
  const getTimeline = useMemo(() => {
    const defaultTime: OrderUpdateResponse[] = [
      {
        id: 0,
        Status: 'Confirmed',
        Time: selectedAssignOrder?.time as string,
        OrderId: selectedAssignOrder?.id as number,
        TrackingId: '',
      },
    ]
    let timeline: OrderUpdateResponse[] = [...defaultTime]
    if (
      ...
      timeline = [
        ...defaultTime,
        ...(selectedAssignOrder?.OrderTrack as OrderUpdateResponse[]),
      ]
    }
    return timeline
  }, [selectedAssignOrder])
